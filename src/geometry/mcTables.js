...
// Standard Paul Bourke tables. EDGE_TABLE[cubeIndex] is a 12-bit mask of which
// cube edges are crossed by the surface; TRI_TABLE[cubeIndex] lists the edges
// (in triples) forming the triangles for that configuration, terminated by -1.
// These are the canonical values used by virtually every marching-cubes
// implementation.
...
// TRI_TABLE: 256 rows, each up to 16 entries (5 triangles max + terminator).
// Stored as a flat array of arrays for clarity.
const TRI_TABLE = [
