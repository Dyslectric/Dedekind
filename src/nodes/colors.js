...
const GEOM_TYPES = new Set(["curve3d","fn1d","surf3d","paramsurf","plane","point","pointSeq","quiver2d","quiver3d","flow","glyphField","scalarFn","paramSpace","points","rawGeom","transformer","equation"]);
const DEFAULT_GEOM_COLOR = {
  ...
  scalarFn:"#6df", paramSpace:"#b4f", points:"#f9a",
