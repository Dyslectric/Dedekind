...
function Benchmarks(){
  return <div style={S.page}>
    <div style={S.wrap}>
      ...
      <p style={S.foot}>Raw-geometry showcase scenes live on their own page at
        <code> #raw-showcases</code>. Leave with the back button or by clearing the
        <code> #bench</code> hash.</p>
    </div>
  </div>;
}
