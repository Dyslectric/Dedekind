    ...
    pages: [
      ...
      },
      {
        ...
        steps: [
          ...
          { heading: "Structure as data, geometry as a rule", body: "It is built from the same parts as the polyhedra. The octahedron centres are generated into three Lists, and one raw-geometry index template stamps an octahedron's eight faces at each centre. Here a shallower depth is coloured by list position, so each octahedron reads as one entry generated in order. The recursion lives as data in the lists; the drawing is one rule repeated, which is how the depth-six shape (46,656 octahedra) stays a small graph rather than a table of coordinates.", kind: "sierpinski-data" },
