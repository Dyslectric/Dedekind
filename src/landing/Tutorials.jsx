    ...
    pages: [
      ...
      },
      {
        ...
        steps: [
          ...
          { heading: "A minimal surface", body: "Beyond connectivity, curvature distinguishes surfaces. A minimal surface is one that locally minimizes area, balancing its bending so the mean curvature is zero everywhere — it saddles equally in both directions at every point. The Schwarz P surface, cos x + cos y + cos z = 0, is the classic triply-periodic example: it carves space into two identical interpenetrating networks of channels meeting at right angles, the 'plumber's nightmare'. Boundaryless and of unbounded genus, ray-marched straight from its equation and coloured by orientation.", kind: "tut-schwarz" },
