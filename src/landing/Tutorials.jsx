    ...
    pages: [
      ...
      },
      {
        ...
        steps: [
          ...
          { heading: "The same roots as a live field", body: "The cloud above is a precomputed list of points. The same roots can instead be drawn implicitly: take F(z) = the smallest value of |c0 + c1 z + ... + cd z^d| over all the ±1 sign choices, which is exactly zero where some ±1 polynomial vanishes. That makes F = 0 the implicit equation of the root set, and colouring brightness by a glow that lights up where F approaches zero draws the roots with no list at all, evaluated per pixel so it pans and zooms live (drag the glow slider to sharpen the points). The price is that F is a minimum over 2^d sign choices, so the expression doubles with every added degree; this is degree four, enough to show the early ring and its gaps. The full fractal needs a high degree, too many sign choices for one formula, so the dense view stays a computed cloud.", kind: "littlewood-field" },
        ],
      },
    ],
  },
