...
function dcMovableRootsScene(){
  ...
  tr.props.mode="graph";tr.props.inAxis0="x";tr.props.inAxis1="y";tr.props.outAxis0="z";
  tr.props.aMin=String(-R);tr.props.aMax=String(R);tr.props.bMin=String(-R);tr.props.bMax=String(R);tr.props.res="200";
  // GPU material-RGB path. The colour reads re()/im() of the complex root sliders;
  // those transpile to decomposed re_/im_ float uniforms, so the whole surface
  // renders (and updates as you drag a joysquare) on the GPU — no CPU per-vertex.
  tr.props.showWire=false;tr.props.shading="lit";tr.props.matColorMode="rgb";tr.props.matUnlit=true;
