...
import { kindEnabled, ALL_KINDS } from "./nodes/kinds.js";
import { UICtx, buildUI, makeS, darken, relLum } from "./theme/tokens.jsx";
...
import { ViewportStrip, DetachedWindow } from "./components/Viewport.jsx";
import { PropsPanelWindow } from "./components/primitives.jsx";

// Demo route helper (duplicated from App.jsx so this lazy chunk has no import
// back-edge into the entry module): "#demo" / "#demo=<kind>" boots a showcase.
